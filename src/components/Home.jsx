...
const Home = () => {
  return (
    <div name="home"className="h-fit md:h-screen w-full bg-gradient-to-b from-black via-black to-gray-800 
    ">
        ...
        '>
           <div className='flex flex-col justify-center h-full'>
              ...
              <p className='text-gray-500 py-4 max-w-md'>
                I have just gotten into development . I love to work on tech-stack like React , Tailwind , Next JS and GraphQL.
              </p>
